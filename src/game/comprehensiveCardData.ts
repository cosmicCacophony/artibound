import { Hero, BaseCard, GenericUnit, SpellCard, SpellEffect, BattlefieldDefinition, Color, HeroAbility, ArtifactCard, Seal } from './types'

// ============================================================================
// SINGLE-LANE PROTOTYPE DATA
// ============================================================================

export const manualPrototypeRBCommanders: Omit<Hero, 'location' | 'owner'>[] = [
  {
    id: 'manual-rb-commander-flame-marshal',
    name: 'Flame Marshal',
    description: 'First Strike. Reliable red commander that wins fair combats.',
    cardType: 'hero',
    colors: ['red'],
    manaCost: 3,
    runeCost: ['red'],
    ...
    supportEffect: 'First Strike',
    equippedItems: [],
  },
  {
    id: 'manual-rb-commander-shadowblade',
    name: 'Shadowblade',
    description: 'Deathtouch. Trades up with anything that blocks it or that it blocks.',
    cardType: 'hero',
    colors: ['black'],
    manaCost: 3,
    runeCost: ['black'],
    ...
    currentHealth: 3,
    keywords: ['deathtouch'],
    supportEffect: 'Deathtouch',
    equippedItems: [],
  },
]

export const manualPrototypeGWCommanders: Omit<Hero, 'location' | 'owner'>[] = [
  {
    id: 'manual-gw-commander-grove-titan',
    name: 'Grove Titan',
    description: 'Trample. A large green threat that converts rune scaling into tower pressure.',
    cardType: 'hero',
    colors: ['green'],
    manaCost: 4,
    runeCost: ['green'],
    ...
    currentHealth: 4,
    keywords: ['trample'],
    supportEffect: 'Trample',
    equippedItems: [],
  },
  {
    id: 'manual-gw-commander-shield-captain',
    name: 'Shield Captain',
    description: 'Vigilance. Steady defensive commander for the slower deck.',
    cardType: 'hero',
    colors: ['white'],
    manaCost: 3,
    runeCost: ['white'],
    ...
    currentHealth: 4,
    keywords: ['vigilance'],
    supportEffect: 'Vigilance',
    equippedItems: [],
  },
]

export const manualPrototypeRBSeals: Omit<Seal, 'owner'>[] = [
  {
    id: 'manual-seal-red',
    name: 'Red Seal',
    color: 'red',
...
export const manualPrototypeGWSeals: Omit<Seal, 'owner'>[] = [
  {
    id: 'manual-seal-green',
    name: 'Green Seal',
    color: 'green',
    manaCost: 2,
    tapped: false,
...
export const manualPrototypeRBPool: (Omit<GenericUnit, 'location' | 'owner' | 'stackedWith' | 'stackPower' | 'stackHealth'> | Omit<SpellCard, 'location' | 'owner'>)[] = [
  {
    id: 'manual-rb-goblin-raider',
    name: 'Goblin Raider',
    description: 'A fast attacker that punishes slow starts.',
    cardType: 'generic',
    colors: ['red'],
    manaCost: 1,
    attack: 2,
  ...
  {
    id: 'manual-rb-blood-knight',
    name: 'Blood Knight',
    description: 'A premium early attacker for the aggressive deck.',
    cardType: 'generic',
    colors: ['black'],
    manaCost: 2,
    attack: 3,
  ...
  {
    id: 'manual-rb-shadow-hexer',
    name: 'Shadow Hexer',
    description: 'Deploy: apply Weak 1 to an enemy creature.',
    cardType: 'generic',
    colors: ['black'],
    manaCost: 2,
    attack: 2,
  ...
  {
    id: 'manual-rb-death-bolt',
    name: 'Death Bolt',
    description: 'Deal 4 damage to target creature. Requires deep rune investment.',
    cardType: 'spell',
    colors: ['red', 'black'],
    manaCost: 2,
    runeCost: ['red', 'red', 'black'],
    effect: {
...
export const manualPrototypeGWPool: (Omit<GenericUnit, 'location' | 'owner' | 'stackedWith' | 'stackPower' | 'stackHealth'> | Omit<SpellCard, 'location' | 'owner'>)[] = [
  {
    id: 'manual-gw-forest-guard',
    name: 'Forest Guard',
    description: 'An efficient wall that buys time for rune growth.',
    cardType: 'generic',
    colors: ['green'],
    manaCost: 2,
    attack: 1,
  ...
  {
    id: 'manual-gw-woodland-striker',
    name: 'Woodland Striker',
    description: 'A compact green threat with trample.',
    cardType: 'generic',
    colors: ['green'],
    manaCost: 2,
    attack: 2,
  ...
  {
    id: 'manual-gw-battle-chaplain',
    name: 'Battle Chaplain',
    description: 'Deploy: give a friendly creature Strength 1.',
    cardType: 'generic',
    colors: ['white'],
    manaCost: 1,
    attack: 1,
  ...
  {
    id: 'manual-gw-ancient-treant',
    name: 'Ancient Treant',
    description: 'A huge rune payoff that ends games if unanswered.',
    cardType: 'generic',
    colors: ['green', 'white'],
    manaCost: 4,
    runeCost: ['green', 'green', 'white', 'white'],
    attack: 6,
    health: 7,
    maxHealth: 7,
    currentHealth: 7,
...
export const prototypeRedHeroes: Omit<Hero, 'location' | 'owner'>[] = [
  {
    id: 'proto-red-hero-flame-captain',
    name: 'Flame Captain',
    description: 'Commander aura. Friendly units gain +1 attack in combat.',
    cardType: 'hero',
    colors: ['red'],
    attack: 4,
    health: 8,
    ...
    prototypeKey: 'flameCaptain',
    supportEffect: 'Friendly units gain +1 attack in combat.',
    equippedItems: [],
  },
  {
    id: 'proto-red-hero-berserker',
    name: 'Ash Berserker',
    description: 'Whenever your side attacks in combat, deal 1 damage to a random enemy unit.',
    cardType: 'hero',
    colors: ['red'],
    attack: 3,
    health: 7,
    maxHealth: 7,
    currentHealth: 7,
    prototypeKey: 'berserker',
    supportEffect: 'Each combat round, pings a random enemy unit for 1.',
    equippedItems: [],
  },
]

export const prototypeGWHeroes: Omit<Hero, 'location' | 'owner'>[] = [
  {
    id: 'proto-gw-hero-nature-guardian',
    name: 'Nature Guardian',
    description: 'Friendly units have 1 armor each combat round.',
    cardType: 'hero',
    colors: ['green'],
    attack: 2,
    health: 9,
    ...
    currentHealth: 9,
    formationTag: 'frontline',
    prototypeKey: 'natureGuardian',
    supportEffect: 'Friendly units reduce the first damage they take each round by 1.',
    equippedItems: [],
  },
  {
    id: 'proto-gw-hero-inspiring-commander',
    name: 'Inspiring Commander',
    description: 'After combat, a random surviving friendly unit gets a permanent +1/+1 counter.',
    cardType: 'hero',
    colors: ['white'],
    attack: 3,
    health: 8,
    maxHealth: 8,
    currentHealth: 8,
    prototypeKey: 'inspiringCommander',
    supportEffect: 'After combat, a random survivor gets +1/+1.',
    equippedItems: [],
  },
]

export const prototypeRedUnits: Omit<GenericUnit, 'location' | 'owner' | 'stackedWith' | 'stackPower' | 'stackHealth'>[] = [
  {
    id: 'proto-red-unit-brash-vanguard',
    name: 'Brash Vanguard',
    description: 'A sturdy frontline attacker.',
    cardType: 'generic',
    colors: ['red'],
    manaCost: 2,
    attack: 3,
  ...
  {
    id: 'proto-red-unit-ember-archer',
    name: 'Ember Archer',
    description: 'Backline attacker that shoots over defenders.',
    cardType: 'generic',
    colors: ['red'],
    manaCost: 2,
    attack: 2,
    ...
    currentHealth: 2,
    formationTag: 'ranged',
    unitTags: ['archer', 'backline'],
  },
  {
    id: 'proto-red-unit-lane-raider',
    name: 'Lane Raider',
    description: 'Fast unit that pressures exposed backlines.',
    cardType: 'generic',
    colors: ['red'],
    manaCost: 3,
    attack: 4,
    ...
    unitTags: ['raider', 'backline'],
  },
  {
    id: 'proto-red-unit-war-drummer',
    name: 'War Drummer',
    description: 'A flexible support body for aggressive turns.',
    cardType: 'generic',
    colors: ['red'],
    manaCost: 1,
    attack: 1,
  ...
  {
    id: 'proto-red-unit-scorch-fanatic',
    name: 'Scorch Fanatic',
    description: 'A cheap attacker that scales well with buffs.',
    cardType: 'generic',
    colors: ['red'],
    manaCost: 1,
    attack: 2,
...
export const prototypeGWUnits: Omit<GenericUnit, 'location' | 'owner' | 'stackedWith' | 'stackPower' | 'stackHealth'>[] = [
  {
    id: 'proto-gw-unit-oakshield-warden',
    name: 'Oakshield Warden',
    description: 'A resilient frontline defender.',
    cardType: 'generic',
    colors: ['green'],
    manaCost: 2,
    attack: 1,
  ...
  {
    id: 'proto-gw-unit-vine-archer',
    name: 'Vine Archer',
    description: 'Reliable ranged support.',
    cardType: 'generic',
    colors: ['green'],
    manaCost: 2,
    attack: 2,
  ...
  {
    id: 'proto-gw-unit-dawn-scout',
    name: 'Dawn Scout',
    description: 'A light backline flanker.',
    cardType: 'generic',
    colors: ['white'],
    manaCost: 3,
    attack: 3,
    ...
    currentHealth: 2,
    formationTag: 'assassin',
    unitTags: ['scout', 'backline'],
  },
  {
    id: 'proto-gw-unit-sunlit-healer',
    name: 'Sunlit Healer',
    description: 'A sticky support unit that benefits from long games.',
    cardType: 'generic',
    colors: ['white'],
    manaCost: 1,
    attack: 1,
  ...
  {
    id: 'proto-gw-unit-bloom-knight',
    name: 'Bloom Knight',
    description: 'Midrange body that thrives with broad buffs.',
    cardType: 'generic',
    colors: ['green', 'white'],
    manaCost: 3,
    attack: 3,
...
export const prototypeRedSpells: Omit<SpellCard, 'location' | 'owner'>[] = [
  {
    id: 'proto-red-spell-battle-fury',
    name: 'Battle Fury',
    description: 'All frontline units get +2/+0 this turn.',
    cardType: 'spell',
    colors: ['red'],
    manaCost: 2,
    effect: { type: 'buff_tag', targetTag: 'frontline', attackBuff: 2, healthBuff: 0 },
  },
  {
    id: 'proto-red-spell-war-cry',
    name: 'War Cry',
    description: 'All friendly units get +1/+1 this turn.',
    cardType: 'spell',
    colors: ['red'],
    manaCost: 3,
    effect: { type: 'buff_all', attackBuff: 1, healthBuff: 1 },
  },
  {
    id: 'proto-red-spell-berserker-rage',
    name: 'Berserker Rage',
    description: 'All assassin units get +3/+0 this turn.',
    cardType: 'spell',
    colors: ['red'],
    manaCost: 2,
    effect: { type: 'buff_tag', targetTag: 'assassin', attackBuff: 3, healthBuff: 0 },
  },
  {
    id: 'proto-red-spell-rallying-shout',
    name: 'Rallying Shout',
    description: 'All friendly units get +0/+1 this turn.',
    cardType: 'spell',
    colors: ['red'],
    manaCost: 1,
    effect: { type: 'buff_all', attackBuff: 0, healthBuff: 1 },
  },
]

export const prototypeGWSpells: Omit<SpellCard, 'location' | 'owner'>[] = [
  {
    id: 'proto-gw-spell-shield-wall',
    name: 'Shield Wall',
    description: 'All frontline units get +0/+3 this turn.',
    cardType: 'spell',
    colors: ['green', 'white'],
    manaCost: 2,
    effect: { type: 'buff_tag', targetTag: 'frontline', attackBuff: 0, healthBuff: 3 },
  },
  {
    id: 'proto-gw-spell-natures-blessing',
  ...
  {
    id: 'proto-gw-spell-inspiring-light',
    name: 'Inspiring Light',
    description: 'All ranged units get +2/+1 this turn.',
    cardType: 'spell',
    colors: ['white'],
    manaCost: 2,
    effect: { type: 'buff_tag', targetTag: 'ranged', attackBuff: 2, healthBuff: 1 },
  },
  {
    id: 'proto-gw-spell-fortify',
    name: 'Fortify',
    description: 'All friendly units get +0/+2 this turn.',
    cardType: 'spell',
    colors: ['green'],
    manaCost: 1,
    effect: { type: 'buff_all', attackBuff: 0, healthBuff: 2 },
  },
]
