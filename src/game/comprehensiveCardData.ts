...
export const rwHeroes: Omit<Hero, 'location' | 'owner'>[] = [
  ...
  // BR Aggressive Spell-Synergy Heroes
  {
    ...
    name: 'Spell Slinger',
    description: '3/4. Whenever you cast a spell in this lane, this hero gains +2/+0 until end of turn.',
    cardType: 'hero',
    colors: ['red'],
    attack: 3,
    health: 4,
    maxHealth: 4,
    currentHealth: 4,
    supportEffect: 'Gains +2/+0 when you cast a spell in this lane.',
    equippedItems: [],
    ability: {
      name: 'Spell Mastery',
      description: 'Passive: Whenever you cast a spell in this lane, this hero gains +2/+0 until end of turn.',
      manaCost: 0,
      cooldown: 0,
  ...
  },
  {
    ...
    description: '2/5. Whenever you cast a spell in this lane, deal 1 damage to the opposing tower.',
    cardType: 'hero',
    colors: ['red'],
    attack: 2,
    health: 5,
    maxHealth: 5,
    currentHealth: 5,
    supportEffect: 'Converts lane spells into tower damage.',
    equippedItems: [],
    ability: {
      name: 'Spell Burn',
      description: 'Passive: Whenever you cast a spell in this lane, deal 1 damage to the opposing tower.',
      manaCost: 0,
      cooldown: 0,
      trigger: 'on_spell_cast',
...
export const rbCards: Omit<GenericUnit, 'location' | 'owner' | 'stackedWith' | 'stackPower' | 'stackHealth'>[] = [
  ...
  {
    id: 'rb-unit-rune-thief',
    name: 'Rune Thief',
    description: '2/2. When this deals tower damage, steal 1 random permanent rune from the opponent. Costs 3RB.',
    cardType: 'generic',
    colors: ['red', 'black'],
    manaCost: 3,
    consumesRunes: true,
    ...
    maxHealth: 2,
    currentHealth: 2,
    specialEffects: ['rune_steal'],
  },
  {
    id: 'rb-unit-mana-leech',
    name: 'Mana Leech',
    description: '3/4. When this deals tower damage, steal 1 random permanent rune from the opponent. Costs 5RB.',
    cardType: 'generic',
    colors: ['red', 'black'],
    manaCost: 5,
    consumesRunes: true,
  ...
  {
    id: 'rb-unit-vault-raider',
    name: 'Vault Raider',
    description: '5/3. When this deals tower damage, steal 1 random permanent rune from the opponent. Costs 6RB.',
    cardType: 'generic',
    colors: ['red', 'black'],
    manaCost: 6,
    consumesRunes: true,
