...
export const rwHeroes: Omit<Hero, 'location' | 'owner'>[] = [
  ...
  // Strong Mono-Red Hero
  {
    ...
    name: 'Fury Champion',
    description: '6/5. Powerful mono-red hero with signature spell and strong ability.',
    cardType: 'hero',
    colors: ['red'],
    attack: 6,
    health: 5,
...
export const rbSpells: Omit<SpellCard, 'location' | 'owner'>[] = [
  ...
  },
  {
    ...
    description: 'All enemies get -1/-1 permanently. At the start of the next 2 turns, repeat this effect. Costs 6B.',
    cardType: 'spell',
    colors: ['black'],
    manaCost: 6,
    consumesRunes: true,
  ...
  },
  {
    ...
    consumesRunes: true,
    effect: {
      type: 'targeted_damage', // Placeholder - would need custom effect for chain bounce damage
      damage: 2,
      affectsUnits: true,
      affectsHeroes: true,
    },
...
export const ubSpells: Omit<SpellCard, 'location' | 'owner'>[] = [
  ...
  },
  {
    ...
    name: 'Assassinate',
    description: 'Deal 4 damage to target hero. As an additional cost, discard a random card from your hand.',
    cardType: 'spell',
    colors: ['black'],
    manaCost: 3,
    consumesRunes: true,
...
export const wguCards: Omit<GenericUnit, 'location' | 'owner' | 'stackedWith' | 'stackPower' | 'stackHealth'>[] = [
  ...
  },
  {
    ...
    description: '5/5. Adjacent units get 3 regen and +2/+2. Costs 5UUW.',
    cardType: 'generic',
