...
export const rwHeroes: Omit<Hero, 'location' | 'owner'>[] = [
  ...
  // Red Cleave Hero (Sven-like) - Tool to deal with creep-stacking cards
  {
    id: 'red-hero-cleaver',
    name: 'Cleave Warrior',
    description: '3/5. Cleave (damages adjacent units when attacking). Red\'s answer to stacked creeps. Especially aggressive hero.',
    cardType: 'hero',
    colors: ['red'],
    attack: 3,
    health: 5,
...
export const monoRedAggroSpells: Omit<SpellCard, 'location' | 'owner'>[] = [
  // REMOVED: Fire Bolt - No longer fits color identity
...
export const rwgHeroes: Omit<Hero, 'location' | 'owner'>[] = [
  ...
  // Rare Heroes - Double Color Requirements (Draft Dopamine Hits)
  {
    ...
    name: 'Wild Fury',
    description: 'Rare. Mighty units synergy.',
    cardType: 'hero',
    colors: ['red', 'green'],
    attack: 4,
    health: 4,
...
export const uwHeroes: Omit<Hero, 'location' | 'owner'>[] = [
  ...
  },
  {
    id: 'uw-hero-mage',
    name: 'Divine Mage',
    description: 'Mobile control hero',
    cardType: 'hero',
    colors: ['blue'],
    attack: 3,
    health: 4,
