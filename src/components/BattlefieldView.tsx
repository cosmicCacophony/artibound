  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
        ...
        {/* Go to Combat Button - Resolves Both Battlefields Simultaneously (hidden in prototype: auto-triggers) */}
        {metadata.currentPhase === 'play' && battlefieldId === 'battlefieldA' && !metadata.isRunePrototype && (
          <button
            onClick={() => {
